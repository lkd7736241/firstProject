...
//	update_at	bigint	6	0	-1	0	0	0				最后修改时间					0	0	0	0	0	0	0
	...
	public String getGraduateSchoo() {
		return graduateSchool;
	}
	public void setGraduateSchoo(String graduateSchoo) {
		this.graduateSchool = graduateSchoo;
	}
	...
	public String toString() {
		return "ApplicationForm [id=" + id + ", name=" + name + ", qq=" + qq + ", type=" + type + ", admissionTime="
				+ admissionTime + ", graduateSchool=" + graduateSchool + ", studentIdOnWeb=" + studentIdOnWeb
				+ ", dailyLink=" + dailyLink + ", slogan=" + slogan + ", brother=" + brother + ", messageChannel="
				+ messageChannel + ", createAt=" + createAt + ", updateAt=" + updateAt + "]";
	}
